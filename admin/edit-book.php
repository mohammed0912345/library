...
$query->execute();
$_SESSION['msg']="تم تعديل الكتاب بنجاح";
...
<head>
    ...
    <title>نظام إدارة المكتبة | تعديل بيانات الكتاب</title>
...
<div class="form-group">
<label> الصنف<span style="color:red;">*</span></label>
