...
$_SESSION['msg']="تم إرجاع الكتاب بنجاح";
...
<head>
    ...
    <title>نظام ادارة المكتبه | تتفاصيل الكتب التي تم تسليمها</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">تفاصيل الكتب التي تم تسليمها</h4>
...
<div class="form-group">
<label>تاريخ تسليم الكتاب :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div>


<div class="form-group">
<label>ززمن إرجاع الكتاب</label>
...
<div class="form-group">
<label>الغرامه(جنيه سوداني) :</label>
<?php 
if($result->fine=="")
{?>
...
<button type="submit" name="return" id="submit" class="btn btn-info">إرجاع الكتاب </button>
