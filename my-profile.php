...
echo '<script>alert("تم تعديل الصفحة الشخصية بنجاح")</script>';
}
...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>نظام إدارة المكتبة | إتسجيل طالب</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">صفحتي الشخصية</h4>
...
<label>رقم الطالب المتسلسل : </label>
...
<div class="form-group">
<label>حالة الصفحة الشخصية : </label>
...
<button type="submit" name="update" class="btn btn-primary" id="submit">تعديل </button>
