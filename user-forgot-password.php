...
<head>
    ...
    <title>نزام إدارة المكتبة | إسترجاع كلمة المرور </title>
...
<div class="col-md-12">
<h4 class="header-line">إسترجاع كلمة المرور</h4>
</div>
</div>
...
<label>إدخل البريد الإلكتروني</label>
<input class="form-control" type="email" name="email" required autocomplete="off" />
</div>

<div class="form-group">
<label>إدخل رقم الهاتف</label>
<input class="form-control" type="text" name="mobile" required autocomplete="off" />
</div>

<div class="form-group">
<label>إدخل كلمة المرور الجديدة</label>
...
<input type="text" class="form-control1"  name="vercode" maxlength="5" autocomplete="off" required  style="height:25px;" />&nbsp;<img src="captcha.php">
 ...
 <button type="submit" name="change" class="btn btn-info">تغيير كلمة المرور</button> | <a href="index.php">تسجيل الدخول</a>
</form>
 </div>
</div>
</div>
